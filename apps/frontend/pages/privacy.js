  ...
  return (
    <div className={styles.container}>
      ...
      <p>
        ...
        advertising partners of tesKoran.id.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on tesKoran.id, which are sent
      ...
      <p>
        Note that tesKoran.id has no access to or control over these cookies
      ...
      <p>
        tesKoran.id does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in tesKoran.id. This policy is not applicable to
