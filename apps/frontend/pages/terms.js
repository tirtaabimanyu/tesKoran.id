...
export default function Terms() {
  return (
    <div className={styles.container}>
      ...
      <p>Welcome to tesKoran.id!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of tesKoran.id&apos;s Website, located at https://teskoran.id.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use tesKoran.id if you do not agree to
      ...
      <p>
        ...
        taken as interchangeable and therefore as referring to same. Our Terms
      ...
      <p>
        We employ the use of cookies. By accessing tesKoran.id, you agreed to
        use cookies in agreement with the tesKoran.id&apos;s Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, tesKoran.id and/or its licensors own the
        intellectual property rights for all material on tesKoran.id. All
        intellectual property rights are reserved. You may access this from
        tesKoran.id for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from tesKoran.id</li>
        <li>Sell, rent or sub-license material from tesKoran.id</li>
        <li>Reproduce, duplicate or copy material from tesKoran.id</li>
        <li>Redistribute content from tesKoran.id</li>
      </ul>
      ...
      <p>
        ...
        tesKoran.id does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of tesKoran.id,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, tesKoran.id shall not be
      ...
      <p>
        tesKoran.id reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant tesKoran.id a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of tesKoran.id; and (d) the link
      ...
      <p>
        ...
        e-mail to tesKoran.id. Please include your name, your organization name,
      ...
      <p>
        No use of tesKoran.id&apos;s logo or other artwork will be allowed for
